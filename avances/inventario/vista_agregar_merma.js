...
//botones del mermar
var volver_merma = document.querySelector(".volver_merma");
var salir_merma = document.querySelector(".salir_merma");
var siguiente_merma = document.querySelector(".siguiente_merma");
var enviar_merma = document.querySelector(".enviar_merma");



//inputs del merma
var input_merma1 = document.querySelector("#id_merma");
var input_merma2 = document.querySelector("#cantidad_merma");
var input_merma3 = document.querySelector("#causa_merma");
var input_merma4 = document.querySelector("#fecha_merma");
